...
export const API_KEY_ERROR_MESSAGE = "Chave de API não configurada. Por favor, defina a variável de ambiente API_KEY.";
...
// Simulação de ML (usada como confluência)
export const ML_TARGET_HORIZON_CANDLES = 12; // ex: 12 * 15min = 3 horas
export const ML_CONFIDENCE_THRESHOLD = 0.60;

// Sentimento (usado como confluência)
export const SENTIMENT_POSITIVE_THRESHOLD = 0.1;
export const SENTIMENT_NEGATIVE_THRESHOLD = -0.1;
