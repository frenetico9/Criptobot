...
export const SMC_POI_FVG_MIN_ATR_FACTOR = 0.15; // Minimum FVG size relative to ATR (Reduced from 0.2)
export const SMC_POI_ORDER_BLOCK_IMBALANCE_MIN_FACTOR = 0.1; // Min imbalance size relative to OB body for it to be valid
export const SMC_SL_ATR_MULTIPLIER = 1.0; // Stop loss placement based on ATR below/above POI structure
export const SMC_SL_BUFFER_PIPS_FACTOR = 0.0005; // Small additional buffer for SL (adjust for asset volatility if needed)
export const SMC_STRATEGY_MIN_RR_RATIO = 2.0; // Minimum Risk-to-Reward for the SMC strategy
export const SMC_MAX_DISTANCE_IDM_TO_POI_ATR_FACTOR = 5; // Max distance from IDM to POI in ATR multiples

// Killzones (UTC Times)
export const LONDON_KILLZONE_UTC_START = 7;  // 2 AM NYT / 7:00 UTC (approx, considering DST changes)
export const LONDON_KILLZONE_UTC_END = 10;   // 5 AM NYT / 10:00 UTC
export const NEWYORK_KILLZONE_UTC_START = 12; // 7 AM NYT / 12:00 UTC (approx)
export const NEWYORK_KILLZONE_UTC_END = 15;   // 10 AM NYT / 15:00 UTC

// Candlestick Pattern Recognition (values remain, usage changes to confluence for SMC)
...
export const NUM_CANDLES_TO_FETCH = 350; // Increased slightly to accommodate more lookback for SMC
export const NUM_CANDLES_TO_DISPLAY = 150;

// Volume Context (can be a confluence)
export const VOLUME_SPIKE_RATIO = 1.8; 

// Configurações de Backtest de Estratégia
export const BACKTEST_PERIOD_DAYS = 90; 
...
export const BACKTEST_RISK_PER_TRADE_BRL = 25; // Fixed BRL risk per trade

// General Liquidity Context Windows (UTC hours) - Can still be useful contextual info
export const GENERAL_LIQUIDITY_WINDOW_EUROPE_US_UTC_START = 12; // Broader than NY KZ
export const GENERAL_LIQUIDITY_WINDOW_EUROPE_US_UTC_END = 17;
export const GENERAL_LIQUIDITY_WINDOW_ASIA_UTC_START = 0; // Video mentions Asian sweep, aligning to typical Asian session
export const GENERAL_LIQUIDITY_WINDOW_ASIA_UTC_END = 8; 

// Volatility Context (ATR based) - Can still be useful contextual info
...
// export const EMA_LONG_PERIOD = 21;  // Replaced by SMC POIs
...
// export const STRATEGY_SL_ATR_MULTIPLIER = 1.5;  // Replaced by SMC_SL_ATR_MULTIPLIER
// export const STRATEGY_RR_RATIO = 1.5; // Replaced by SMC_STRATEGY_MIN_RR_RATIO
// export const STRATEGY_VOLUME_CONFIRMATION_RATIO = 1.2; 
// export const STRATEGY_MIN_CONFLUENCES_FOR_STRONG_SIGNAL = 2; 
// export const SMC_LOOKBACK_PERIOD_CANDLES = 30; // Replaced by SMC_MARKET_STRUCTURE_LOOKBACK
// export const SMC_FVG_MIN_ATR_FACTOR = 0.3; // Replaced by SMC_POI_FVG_MIN_ATR_FACTOR
